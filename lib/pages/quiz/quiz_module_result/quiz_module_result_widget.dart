...
import 'quiz_module_result_model.dart';
export 'quiz_module_result_model.dart';

class QuizModuleResultWidget extends StatefulWidget {
  const QuizModuleResultWidget({Key? key}) : super(key: key);

  @override
  _QuizModuleResultWidgetState createState() => _QuizModuleResultWidgetState();
}

class _QuizModuleResultWidgetState extends State<QuizModuleResultWidget> {
  late QuizModuleResultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizModuleResultModel());
